module.exports = (function() {
  ...
  generate_documentation = function(source) {
    return fs.readFile(source, "utf-8", function(error, code) {
      ...
      return highlight(source, sections, function() {
        return generate_html(source, sections);
      });
    });
  };
  ...
  return {
      generate_doc_html = function(source, callback) {
          var html;
          if(source) {
              html = generate_documentation(source);
          }
